			...
			>
				<div className="relative w-full h-[230px]">
					...
					<div className="absolute inset-0 flex justify-end m-3 card-img_hover">
						...
						>
							<img src={github} alt="github img" className="w-1/2 h-1/2 object-contain" />
						</div>
					</div>
				</div>
	...
	return (
		<>
			...
			<div className="w-full flex">
				<motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-3 text-[#aaa6c3] text-[17px] max-w-3xl leading-[30px]">
